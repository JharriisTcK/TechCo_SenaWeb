...
<head>
    ...
    <title>Tokens | PanelNK | TechCo - Tecnología e Innovación</title>
    ...
    <script type="text/javascript" src="../js/TokensBoard_AdminNK.js"></script>
</head>
<body>
    ...
    <main>
        <div class="mainContainer">
            ...
            <script>
                new TokensBoard_AdminNK("#TokensBox", "ActionAdmin.php", "../", {});
