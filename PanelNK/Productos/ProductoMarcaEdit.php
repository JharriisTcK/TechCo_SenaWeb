...
<head>
    ...
    <title>Editar Marca | PanelNK | TechCo - Tecnología e Innovación</title>
    ...
    <script type="text/javascript" src="../../js/ProductosNK_AdminFormMarca.js"></script>
...
<body>
    ...
    <main>
        <div class="mainContainer">
            <div>
            <div id="MarcaAdminEditBox"></div>
                <script type="text/javascript">
                    var nodeProductosMarcasBox=document.querySelector("#MarcaAdminEditBox");
                    new ProductosNK_AdminFormMarca(nodeProductosMarcasBox, "../ActionPanelProductos.php", "<?php echo $ID_in; ?>", "../../", {});
                </script>
            </div>
            <div>
