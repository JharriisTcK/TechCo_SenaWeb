...
<head>
    ...
    <title>Editar Producto | PanelNK | TechCo - Tecnología e Innovación</title>
    ...
    <script type="text/javascript" src="../../js/ProductosNK_AdminFormProducto.js"></script>
        ...
        <div class="mainContainer">
            ...
            <div id="ProductosAdminBox"></div>
                <script type="text/javascript">
                    ...
                    new ProductosNK_AdminFormProducto(nodeProductosBox, "../ActionPanelProductos.php", "<?php echo $ID_in; ?>", "../../", {});
                </script>
            </div>
            <div>
