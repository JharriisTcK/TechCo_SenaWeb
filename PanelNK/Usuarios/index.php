...
<head>
    ...
    <title>Usuarios | PanelNK | TechCo - Tecnología e Innovación</title>
    ...
    <script type="text/javascript" src="../../js/UsuariosNK_Admin.js"></script>
...
<body>
    ...
    <main>
        <div class="mainContainer">
            <div>
            <div id="UsuariosAdminBox"></div>
                <script type="text/javascript">
                    new UsuariosNK_Admin("#UsuariosAdminBox", "../ActionPanelUsuarios.php", "../../", "", {});
